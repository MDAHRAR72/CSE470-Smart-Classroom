...
-- CreateEnum
CREATE TYPE "public"."Day" AS ENUM ('SATURDAY', 'SUNDAY', 'MONDAY', 'TUESDAY', 'WEDNESDAY', 'THURSDAY');
...
-- CreateTable
CREATE TABLE "public"."Gradesheet" (
    "id" SERIAL NOT NULL,
...
-- AddForeignKey
ALTER TABLE "public"."Gradesheet" ADD CONSTRAINT "Gradesheet_examId_fkey" FOREIGN KEY ("examId") REFERENCES "public"."Exam"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Gradesheet" ADD CONSTRAINT "Gradesheet_assignmentId_fkey" FOREIGN KEY ("assignmentId") REFERENCES "public"."Assignment"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."Gradesheet" ADD CONSTRAINT "Gradesheet_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "public"."Student"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
